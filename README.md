...
```
The script uses the bounding box data provided by the Kaggle dataset (in train.csv) to crop the raw images and generates new images of faces. <br>The images are placed in a new *data/* directory under *train/* *valid/* and *test/* in either *mask/* or *no-mask/* based on the image class information provided by the train.csv.<br><br>
